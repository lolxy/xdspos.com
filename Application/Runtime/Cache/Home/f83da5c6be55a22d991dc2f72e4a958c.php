...
<div class="head_title"><!-- HEAD TITLE -->
    <?php if($info["page_name"] == '产品介绍'): ?><a style="display: block;background:url(/Public/Home/images/slider/cpjs.jpg) center center no-repeat;background-size:cover;width:100%;height:350px;" href="#"></a>
    <?php elseif($info["page_name"] == '下载专区'): ?>
    <div style="display: block;background:url(/Public/Home/images/slider/download.jpg) center center no-repeat;background-size:cover;width:100%;height:350px;overflow:hidden;position:relative;" href="#">
    <img src="/Public/Home/images/slider/download.jpg" alt="下载" border="0" usemap="#download" style="position:absolute;left:50%;margin-left:-960px;"/>
<map name="download" id="download">
<area shape="rect" coords="846,249,1043,309" href="#" target="_blank" />
<area shape="rect" coords="1085,250,1283,310" href="#" target="_blank" />
</map>
    </div>
    <?php else: ?>
    <a style="display: block;background:url(/Public/Home/images/slider/other.jpg) center center no-repeat;background-size:cover;width:100%;height:350px;" href="#"></a><?php endif; ?>
...
<div class="main" style="background:rgb(247,247,247);"><!-- MAIN -->
