...
<div class="head_title"><!-- HEAD TITLE -->
   ...
   <a style="display: block;background:url(/Public/Home/images/slider/news.jpg) center center no-repeat;background-size:cover;width:100%;height:350px;" href="#"></a>
...
<div class="breadcrumbs"><!-- BREADCRUMBS -->
    ...
    <div class="container_12">
        	...
        	<span class="weizhi">当前您的位置：</span>

            <a href="/index.php"><?php echo (L("T_RHOME")); ?></a>

            <span>>></span>

            <span class="tit1"><?php echo ($ccname); ?></span>
