...
CREATE TABLE IF NOT EXISTS `xzf_access` (
...
INSERT INTO `xzf_access` (`role_id`, `node_id`, `level`, `pid`, `module`) VALUES
(2, 8, 3, 14, ''),
(2, 14, 2, 1, ''),
(2, 10, 3, 4, ''),
(2, 4, 2, 1, ''),
...
CREATE TABLE IF NOT EXISTS `xzf_ad` (
...
INSERT INTO `xzf_ad` (`id`, `ad_name`, `ad_link`, `ad_img`, `position`, `sort`, `lang`) VALUES
(32, '007', 'http://www.ftde360.com', '550457fb0cf25.jpg', 'index', 7, 'zh-cn'),
(33, '009', 'http://www.ftde360.com', '550457f251766.jpg', 'index', 9, 'zh-cn'),
(34, '010', 'http://www.ftde360.com', '550457e7897b8.jpg', 'index', 10, 'zh-cn');
...
CREATE TABLE IF NOT EXISTS `xzf_admin` (
...
INSERT INTO `xzf_admin` (`aid`, `nickname`, `email`, `pwd`, `status`, `remark`, `find_code`, `time`) VALUES
(1, '超级管理员', 'admin@admin.com', '5a1a77a1a218c7aec78b457986d8c9e2', 1, '我是超级管理员 哈哈~~', NULL, 1426211906);
...
CREATE TABLE IF NOT EXISTS `xzf_category` (
  ...
  `lang` varchar(10) NOT NULL DEFAULT 'zh-cn',
  PRIMARY KEY (`cid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='新闻分类表' AUTO_INCREMENT=58 ;

--
-- 转存表中的数据 `xzf_category`
--

INSERT INTO `xzf_category` (`cid`, `pid`, `name`, `type`, `lang`) VALUES
(1, 0, '新闻动态', 'n', 'zh-cn'),
(57, 0, '信用卡养卡', 'n', 'zh-cn'),
(52, 0, '分类1', 'p', 'zh-cn'),
(55, 0, '分类2', 'p', 'zh-cn'),
...
CREATE TABLE IF NOT EXISTS `xzf_field` (
...
CREATE TABLE IF NOT EXISTS `xzf_images` (
...
INSERT INTO `xzf_images` (`id`, `catname`, `savename`, `savepath`, `create_time`) VALUES
...
CREATE TABLE IF NOT EXISTS `xzf_input` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
CREATE TABLE IF NOT EXISTS `xzf_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `xzf_link` (`id`, `title`, `display`, `link`, `imagepath`, `sort`, `target`) VALUES
(6, '中国农业银行', 1, 'http://www.ftde360.com', '/Uploads/image/links/20150315/20150315004120_80554.jpg', 1, '2'),
(7, '222', 1, 'http://www.ftde360.com', '/Uploads/image/links/20150315/20150315004146_50564.jpg', 2, '2'),
(8, '3333', 1, 'http://www.qq.com', '/Uploads/image/links/20150315/20150315005132_70608.jpg', 3, '2'),
(9, '33', 1, 'http://www.baidu.com', '/Uploads/image/links/20150315/20150315003504_75533.jpg', 1, '1'),
(10, '33333', 1, 'http://www.baidu.com', '/Uploads/image/links/20150315/20150315003650_69356.jpg', 2, '1'),
(11, '4444', 1, 'http://www.baidu.com', '/Uploads/image/links/20150315/20150315005132_70608.jpg', 2, '1'),
(12, '444444', 1, 'http://www.baidu.com', '/Uploads/image/links/20150315/20150315004146_50564.jpg', 2, '1');
...
CREATE TABLE IF NOT EXISTS `xzf_member` (
...
CREATE TABLE IF NOT EXISTS `xzf_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `xzf_message` (`id`, `username`, `email`, `moblie`, `display`, `addtime`, `content`) VALUES
(14, 'qqq', 'qq@qq.com', 'qq', 0, 1426353473, 'qqqq');
...
CREATE TABLE IF NOT EXISTS `xzf_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
CREATE TABLE IF NOT EXISTS `xzf_nav` (
...
INSERT INTO `xzf_nav` (`id`, `module`, `nav_name`, `parent_id`, `guide`, `type`, `link`, `lang`, `sort`, `target`) VALUES
(53, 'page', '产品介绍', 53, 20, 'middle', '/index.php/page/index/name/cpjs', 'zh-cn', 1, 1),
(54, 'page', '产品介绍', 0, 20, 'middle', '/index.php/page/index/name/cpjs', 'zh-cn', 3, 1),
(55, 'page', '下载专区', 0, 21, 'middle', '/index.php/page/index/name/download', 'zh-cn', 2, 1),
(57, 'message', '联系我们', 0, 0, 'middle', '/index.php/message/index', 'zh-cn', 1, 1),
(58, 'news', '新闻动态', 0, 1, 'middle', '/index.php/news/index/cid/1', 'zh-cn', 5, 1),
(59, 'news', '信用卡养卡', 0, 57, 'middle', '/index.php/news/index/cid/57', 'zh-cn', 4, 1),
(60, 'page', '如何使用', 0, 22, 'middle', '/index.php/page/index/name/howuse', 'zh-cn', 3, 1);
...
CREATE TABLE IF NOT EXISTS `xzf_news` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='新闻表' AUTO_INCREMENT=20 ;

--
-- 转存表中的数据 `xzf_news`
--

INSERT INTO `xzf_news` (`id`, `cid`, `title`, `keywords`, `description`, `status`, `summary`, `published`, `update_time`, `content`, `click`, `aid`, `is_recommend`, `image_id`, `lang`) VALUES
...
(13, 1, '规范化规范化广泛用途用途用途用途规范化飞过海集结', '牙痛溶液', '有人体育', 1, '膮', 1394437621, 1394438741, '月try突然', 4, 1, 1, 0, 'zh-cn'),
(14, 1, '如果对符合购房计划将会根据', '激光焊接', '结核杆菌', 1, '几个号', 1394438751, 0, '几个号', 16, 1, 1, 0, 'zh-cn'),
(15, 1, '价格具有统一规划集合计划将会', '', '空军航空', 1, '', 1394438760, 0, '', 4, 1, 1, 0, 'zh-cn'),
(16, 57, '会见法国恢复的规划法规和反光镜', 'gfdg', '激光焊接有一天梵蒂冈梵蒂冈梵蒂冈奋斗', 1, '后果将会根据可更换', 1394438775, 1426225131, '<img src="/newconist/Uploads/image/product/20140303/20140303081406_87297.jpg" alt="" />根据可更换', 48, 1, 1, 0, 'zh-cn'),
(19, 1, '222222', '222', '2222', 1, '22222', 1426344609, NULL, '2222', 1, 1, 1, 0, 'zh-cn');
...
CREATE TABLE IF NOT EXISTS `xzf_node` (
...
INSERT INTO `xzf_node` (`id`, `name`, `title`, `status`, `remark`, `sort`, `pid`, `level`) VALUES
...
CREATE TABLE IF NOT EXISTS `xzf_page` (
...
INSERT INTO `xzf_page` (`id`, `unique_id`, `parent_id`, `page_name`, `content`, `display`, `keywords`, `description`, `lang`) VALUES
(20, 'cpjs', 0, '产品介绍', '<img src="/Public/kindeditor/php/../../../Uploads/image/page/20150314/20150314232547_85382.jpg" alt="" /><img src="/Public/kindeditor/php/../../../Uploads/image/page/20150314/20150314232547_62182.jpg" alt="" /><img src="/Public/kindeditor/php/../../../Uploads/image/page/20150314/20150314232547_18184.jpg" alt="" /><img src="/Public/kindeditor/php/../../../Uploads/image/page/20150314/20150314232547_30426.jpg" alt="" /><img src="/Public/kindeditor/php/../../../Uploads/image/page/20150314/20150314232547_13345.jpg" alt="" /><img src="/Public/kindeditor/php/../../../Uploads/image/page/20150314/20150314232547_68235.jpg" alt="" />', 1, '', '', 'zh-cn'),
(21, 'download', 0, '下载专区', '', 1, '', '', 'zh-cn'),
(22, 'howuse', 0, '如何使用', '', 1, '', '', 'zh-cn'),
(23, 'about', 0, '关于我们', '<img src="/Uploads/image/page/20150315/20150315000408_13677.jpg" alt="" />', 1, '关于我们', '关于我们', 'zh-cn');
...
CREATE TABLE IF NOT EXISTS `xzf_product` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `cid` smallint(3) DEFAULT NULL COMMENT '所在分类',
...
CREATE TABLE IF NOT EXISTS `xzf_role` (
  `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
  `pid` smallint(6) DEFAULT NULL,
...
INSERT INTO `xzf_role` (`id`, `name`, `pid`, `status`, `remark`) VALUES
...
CREATE TABLE IF NOT EXISTS `xzf_role_user` (
...
--
-- 转存表中的数据 `xzf_role_user`
--

INSERT INTO `xzf_role_user` (`role_id`, `user_id`) VALUES
(3, '4');
...
CREATE TABLE IF NOT EXISTS `xzf_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 限制表 `xzf_field`
--
ALTER TABLE `xzf_field`
  ADD CONSTRAINT `xzf_field_ibfk_1` FOREIGN KEY (`model_id`) REFERENCES `xzf_model` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- 限制表 `xzf_input`
--
ALTER TABLE `xzf_input`
  ADD CONSTRAINT `xzf_input_ibfk_1` FOREIGN KEY (`field_id`) REFERENCES `xzf_field` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
